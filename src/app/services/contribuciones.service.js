...
var ContribucionesService = /** @class */ (function () {
    function ContribucionesService(requestService, util) {
    ...
    ContribucionesService.prototype.cargarRoles = function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.cargarRol(rol)];
                    case 3:
                        _d.sent();
                        _d.label = 4;
                    case 4:
    ...
    ContribucionesService.prototype.cargarRol = function (rol) {
        var _this = this;
        if (rol.cuotas.length > 0) {
            ...
            return new Promise(function (resolve, reject) { return _this.getDeudaByRol(rol.rol, []).then(function (data) {
                var mapCuotas = new Map();
                for (var _i = 0, _a = data.listaDeudaRol; _i < _a.length; _i++) {
                    var deuda = _a[_i];
                    var cuota = new Cuota_1.Cuota(deuda);
                    mapCuotas.set(cuota.numeroCuota, cuota);
                    rol.cuotas.push(cuota);
                }
                _this.getDeudaByRol(rol.rol, rol.getCuotasDeseleccionadas()).then(function (data2) {
                    for (var _i = 0, _a = data2.listaDeudaRol; _i < _a.length; _i++) {
                        var deuda = _a[_i];
                        var cuota = mapCuotas.get(deuda.numeroCuota);
                        cuota.liqParcial = new CuotaDetalle_1.CuotaDetalle(deuda);
                    }
                    rol.isProcess = true;
                    resolve();
    ...
    ContribucionesService.prototype.getBienRaizId = function (bienRaiz) {
    ...
    ContribucionesService.prototype.getDeudaByRol = function (rol, cuotas) {
        var body = {
            'idRol': rol,
            'listaCuotas': Array.from(cuotas.values())
        };
        return this.requestService.request(environment_1.environment.servicios.recuperarDeudaRol, body);
    };
